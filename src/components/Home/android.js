  ...
  render() {
    return (
      <svg viewBox="0 0 135 40" className="android">
        ...
        <path className="st0" d="M130,0.8c2.3,0,4.2,1.9,4.2,4.2v30c0,2.3-1.9,4.2-4.2,4.2H5c-2.3,0-4.2-1.9-4.2-4.2V5c0-2.3,1.9-4.2,4.2-4.2
          H130 M130,0H5C2.3,0,0,2.3,0,5v30c0,2.8,2.2,5,5,5h125c2.8,0,5-2.2,5-5V5C135,2.3,132.8,0,130,0L130,0z"/>
        <path className="st1" d="M47.4,10.2c0,0.8-0.2,1.5-0.7,2c-0.6,0.6-1.3,0.9-2.2,0.9c-0.9,0-1.6-0.3-2.2-0.9c-0.6-0.6-0.9-1.3-0.9-2.2
        ...
        <path className="st1" d="M73.6,12.2c-0.6,0.6-1.3,0.9-2.2,0.9c-0.9,0-1.6-0.3-2.2-0.9c-0.6-0.6-0.9-1.3-0.9-2.2s0.3-1.6,0.9-2.2
        ...
        <path className="st2" d="M68.1,21.8c-2.4,0-4.3,1.8-4.3,4.3c0,2.4,1.9,4.3,4.3,4.3c2.4,0,4.3-1.8,4.3-4.3
        ...
        <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="21.7996" y1="33.2903" x2="5.0172" y2="16.5079" gradientTransform="matrix(1 0 0 -1 0 42)">
          <stop offset="0" stopColor="#00A0FF"/>
          <stop offset="6.574450e-03" stopColor="#00A1FF"/>
        ...
        <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="33.8343" y1="21.9986" x2="9.6374" y2="21.9986" gradientTransform="matrix(1 0 0 -1 0 42)">
        ...
        <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="24.8269" y1="19.7039" x2="2.0686" y2="-3.0544" gradientTransform="matrix(1 0 0 -1 0 42)">
          <stop offset="0" stopColor="#FF3A44"/>
          <stop offset="1" stopColor="#C31162"/>
        </linearGradient>
        <path className="st5" d="M27.1,24.2L22.9,20L10.4,32.5c0.5,0.5,1.2,0.5,2.1,0.1L27.1,24.2"/>
        <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="7.2972" y1="41.8238" x2="17.4598" y2="31.6613" gradientTransform="matrix(1 0 0 -1 0 42)">
          <stop offset="0" stopColor="#32A071"/>
          <stop offset="6.850000e-02" stopColor="#2DA771"/>
          <stop offset="0.4762" stopColor="#15CF74"/>
          <stop offset="0.8009" stopColor="#06E775"/>
          <stop offset="1" stopColor="#00F076"/>
        </linearGradient>
        <path className="st6" d="M27.1,15.8L12.5,7.5c-0.9-0.5-1.6-0.4-2.1,0.1L22.9,20L27.1,15.8z"/>
        <path className="st7" d="M27,24.1l-14.5,8.2c-0.8,0.5-1.5,0.4-2,0l0,0l-0.1,0.1l0,0l0.1,0.1l0,0c0.5,0.4,1.2,0.5,2,0L27,24.1L27,24.1z"/>
        ...
        <path className="st9" d="M12.5,7.6L32,18.7c0.6,0.4,1,0.8,1,1.3l0,0c0-0.5-0.3-1-1-1.4L12.5,7.5C11.1,6.7,10,7.3,10,8.9v0.1C10,7.5,11.1,6.8,12.5,7.6z"/>
      </svg>
    )
  }
}
